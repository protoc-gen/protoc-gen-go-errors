...
type Status struct {
	...
	Metadata      map[string]string      `protobuf:"bytes,4,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // A map of metadata for the error, e.g. the trace id
...
var file_errors_errors_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         10500,
		Name:          "errors.default_http_code",
		Tag:           "varint,10500,opt,name=default_http_code",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         10500,
		Name:          "errors.http_code",
		Tag:           "varint,10500,opt,name=http_code",
		Filename:      "errors/errors.proto",
	},
}
...
var (
	...
	E_DefaultHttpCode = &file_errors_errors_proto_extTypes[0]
)

// Extension fields to descriptorpb.EnumValueOptions.
var (
	// optional int32 http_code = 10500;
	E_HttpCode = &file_errors_errors_proto_extTypes[1]
)
...
var file_errors_errors_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x3a, 0x49, 0x0a, 0x11, 0x64, 0x65, 0x66, 0x61, 0x75,
	0x6c, 0x74, 0x5f, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6e, 0x75, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x84, 0x52, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x48, 0x74, 0x74, 0x70, 0x43, 0x6f,
	0x64, 0x65, 0x3a, 0x3f, 0x0a, 0x09, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x12,
	...
	0x6e, 0x73, 0x18, 0x84, 0x52, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x68, 0x74, 0x74, 0x70, 0x43,
	0x6f, 0x64, 0x65, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x69, 0x61, 0x2d, 0x78, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_errors_errors_proto_depIdxs = []int32{
	...
	2, // 1: errors.default_http_code:extendee -> google.protobuf.EnumOptions
	3, // 2: errors.http_code:extendee -> google.protobuf.EnumValueOptions
